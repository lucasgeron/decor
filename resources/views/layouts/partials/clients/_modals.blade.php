                    ...
                    <div class="flex space-x-2">
                        <div class="flex-grow">
                            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-1"
                                for="title">
                                Nome <span class="text-red-700 font-bold text-xs">* </span>
                            </label>
                            <input wire:model="obj.name" class="w-full input" type="text" placeholder="Local">
                        </div>
                    </div>
            ...
            <div class=" w-full px-3 py-3 space-y-2">
                ...
                <div class="flex space-x-2">
                    <div class="flex-grow">
                        ...
                        <input disabled wire:model="obj.name" class="w-full input" type="text" placeholder="--">
                    </div>
                </div>
