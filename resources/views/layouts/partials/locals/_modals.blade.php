                ...
                <div class=" w-full px-3 py-3 space-y-2">
                    ...
                    <div class="flex space-x-2">
                        ...
                        <div class="flex-grow">
                            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-1"
                                for="title">
                                Título <span class="text-red-700 text-xs">* </span>
                            </label>
                    ...
                    <div class="flex space-x-2">
                        ...
                        <div class="flex-1">
                            ...
                            <input wire:model.lazy="obj.phone1" class="w-full input" type="text" placeholder="DDD + Telefone Fixo">
                        </div>
                        ...
                        <div class="flex-1">
                            ...
                            <input wire:model.lazy="obj.phone2" class="w-full input" type="text"
                                placeholder="DDD + Telefone Móvel">
                        </div>
                    </div>
            ...
            <div class=" w-full px-3 py-3 space-y-2">
                <div>
                    ...
                    @if ($obj->status)
                        ...
                        <button disabled class="cursor-default btn-status-on focus:shadow-outlinee">ON</button>
                    @else
                        <button disabled class="cursor-default btn-status-off focus:shadow-outline">OFF</button>
                    @endif
                </div>
                <div>
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-1" for="titler">
                    ...
                    <input wire:model="obj.title" disabled class=" w-full input-disabled" type="text"
