                ...
                <div class=" w-full px-3 py-3 space-y-2">
                    ...
                    <div class="flex space-x-2">
                        ...
                        <div class="flex-1">
                            ...
                            <input wire:model.lazy="obj.phone2" class="w-full input" type="text" placeholder="Número">
                        </div>
                    </div>
            ...
            <div class=" w-full px-3 py-3 space-y-2">
                ...
                <div class="flex space-x-2">
                    <div class="flex-initial">
                        ...
                        <input disabled wire:model="obj.status" type="checkbox" class="checkbox h-9 w-9 md:w-10 md:h-10"
                            @if ($obj->status == 1) checked @endif>
                    </div>
                    <div class="flex-grow">
                ...
                <div class="flex space-x-2">
                    ...
                    <div class="flex-1">
                        ...
                        <input disabled wire:model.lazy="obj.phone2" class="w-full input" type="text" placeholder="--">
                    </div>
                </div>
            </div>
        </div>
    ...
    <x-slot name="content">
            ...
            <div class=" w-full px-3 py-3 space-y-2">
                ...
                <div class="flex space-x-2">
                    ...
                    <div class="flex-1">
                        ...
                        <input disabled wire:model="obj.city" class="w-full input text-sm md:text-base" type="text"
                            placeholder="Bairro">
        ...
        <div class=" justify-end gap-y-2 w-full py-2 ">
            ...
            <a href="{{ route('indexes.index', $obj->id ?? '') }}"><button
                    class="mt-2 w-full  text-center  bg-gray-200 hover:bg-gray-500 focus:shadow-outline text-gray-700 hover:text-white  p-3 rounded-lg focus:outline-none  uppercase tracking-wide font-bold text-xs">Ver
                    Índices </button>
            </a>
