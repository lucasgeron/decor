        ...
        <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class=" pt-8  sm:pt-0">
                    <a href="{{ route('login' )}}" > <img src="{{url('/img/app_shine_full.png')}}" width="400px" alt="logo" ></a>
                </div>

                <div class="flex justify-center">
                    <div class="flex-1 ">
                        <img src="https://jetstream.laravel.com/assets/img/logo.svg" alt="" width="160px" srcset="">
                    </div>
                    <div class="flex-1 text-sm text-gray-500 ml-4">
